...
export default function Hero() {
  return (
    <>
      <div className="container mx-auto items-center flex flex-col md:flex-row justify-between">
        <div className="flex flex-col gap-6">
          ...
          <p className=" text-center md:text-left">
            Explore frontend, backend, database, and tooling options,<br className="hidden lg:block" />compare
            them side by side, and put together the stack that fits your<br className="hidden lg:block" />next
            project.
          </p>
          <div className="flex justify-center md:justify-normal gap-2.5 mt-7">
